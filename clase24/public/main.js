...
//Se renderizan los productos de productos.json
...
//Se renderizan los mensajes de mensajes.json
...
sendMensaje.addEventListener('click', (e)=>{
    ...
    socket.emit('nuevoMensaje', {email: inputEmail.value, mensaje: inputMensaje.value, fecha:'[' + now.toLocaleString() + ']'})
    inputMensaje.value= " "
})
